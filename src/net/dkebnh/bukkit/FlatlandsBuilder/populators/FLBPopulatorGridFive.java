...
public class FLBPopulatorGridFive extends BlockPopulator {
	private int height;
    ...
    public FLBPopulatorGridFive(int height, Material[] BlockFLB, byte[] BlockFLBDV, Material[] PathFLB, byte[] PathFLBDV, boolean plotsEnabled, int plotSize){
        this.height = height;
