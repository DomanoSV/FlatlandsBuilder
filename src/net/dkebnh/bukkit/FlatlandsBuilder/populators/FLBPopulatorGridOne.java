...
public class FLBPopulatorGridOne extends BlockPopulator {
	private int height;
    ...
    public FLBPopulatorGridOne(int height, Material[] BlockFLB, byte[] BlockFLBDV, Material[] PathFLB, byte[] PathFLBDV, boolean plotsEnabled, int plotSize){
        this.height = height;
