...
public class FLBPopulatorGridFour extends BlockPopulator {
	private int height;
    ...
    public FLBPopulatorGridFour(int height, Material[] BlockFLB, byte[] BlockFLBDV, Material[] PathFLB, byte[] PathFLBDV, boolean plotsEnabled, int plotSize){
        this.height = height;
